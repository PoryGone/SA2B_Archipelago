...
public:
	...
	SpriteNode() : name(""), anim(nullptr), displaySize({ 1.0f,1.0f,0.0f }), globalPosition({ 0.0f,0.0f,0.0f }), localPosition({ 0.0f,0.0f,0.0f }), isGlobalPositionDirty(false), parent(nullptr), scale({ 1.0f,1.0f,1.0f }), rotation(0.0f), children(std::vector<SpriteNode*>()), components(std::vector<SpriteComponent*>()), isEnabledDirty(true), enabledSelf(true), enabledInHierarchy(true), color({ 1.0f,1.0f,1.0f,1.0f }) {}
