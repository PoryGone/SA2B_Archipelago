...
std::array<PokemonData, 32> allPokemon =
{
	...
	PokemonData(MGI_Bulbasaur,	std::string("Bulbasaur"),	1,	PokemonType::Grass,		PokemonType::Poison),
	PokemonData(MGI_Charjabug,	std::string("Charjabug"),	7,	PokemonType::Bug,		PokemonType::Electric),
	PokemonData(MGI_Charmander,	std::string("Charmander"),	1,	PokemonType::Fire,		PokemonType::No_Type),
	PokemonData(MGI_Ditto,		std::string("Ditto"),		1,	PokemonType::Normal,	PokemonType::No_Type),
	PokemonData(MGI_Dratini,	std::string("Dratini"),		1,	PokemonType::Dragon,	PokemonType::No_Type),
	PokemonData(MGI_Flamigo,	std::string("Flamigo"),		9,	PokemonType::Flying,	PokemonType::Fighting),
	PokemonData(MGI_Goomy,		std::string("Goomy"),		6,	PokemonType::Dragon,	PokemonType::No_Type),
	PokemonData(MGI_Grimer,		std::string("Grimer"),		1,	PokemonType::Poison,	PokemonType::No_Type),
	PokemonData(MGI_Haunter,	std::string("Haunter"),		1,	PokemonType::Ghost,		PokemonType::Poison),
	PokemonData(MGI_Litwick,	std::string("Litwick"),		5,	PokemonType::Ghost,		PokemonType::Fire),
	PokemonData(MGI_Phantump,	std::string("Phantump"),	6,	PokemonType::Ghost,		PokemonType::Grass),
	PokemonData(MGI_Piplup,		std::string("Piplup"),		3,	PokemonType::Water,		PokemonType::No_Type),
	PokemonData(MGI_Pooper,		std::string("Pooper"),		9,	PokemonType::Poison,	PokemonType::Ground),
	PokemonData(MGI_Porygon,	std::string("Porygon"),		1,	PokemonType::Normal,	PokemonType::No_Type),
	PokemonData(MGI_Roggenrola,	std::string("Roggenrola"),	5,	PokemonType::Rock,		PokemonType::No_Type),
	PokemonData(MGI_Shuckle,	std::string("Shuckle"),		2,	PokemonType::Bug,		PokemonType::Rock),
	PokemonData(MGI_Sinistea,	std::string("Sinistea"),	8,	PokemonType::Ghost,		PokemonType::No_Type),
	PokemonData(MGI_Snom,		std::string("Snom"),		8,	PokemonType::Ice,		PokemonType::Bug),
	PokemonData(MGI_Spiritomb,	std::string("Spiritomb"),	4,	PokemonType::Ghost,		PokemonType::Dark),
	PokemonData(MGI_Sudowoodo,	std::string("Sudowoodo"),	2,	PokemonType::Rock,		PokemonType::No_Type),
	PokemonData(MGI_Surskit,	std::string("Surskit"),		3,	PokemonType::Bug,		PokemonType::Water),
	PokemonData(MGI_Tatsugiri,	std::string("Tatsugiri"),	9,	PokemonType::Dragon,	PokemonType::Water),
	PokemonData(MGI_Togepi,		std::string("Togepi"),		2,	PokemonType::Fairy,		PokemonType::No_Type),
	PokemonData(MGI_Chansey,	std::string("Chansey"),		1,	PokemonType::Normal,	PokemonType::No_Type),
	PokemonData(MGI_UnownQue,	std::string("Unown ?"),		2,	PokemonType::Psychic,	PokemonType::No_Type),
	PokemonData(MGI_UnownX,		std::string("UnownX"),		2,	PokemonType::Psychic,	PokemonType::No_Type),
	PokemonData(MGI_Wailmer,	std::string("Wailmer"),		3,	PokemonType::Water,		PokemonType::No_Type),
	PokemonData(MGI_Wooper,		std::string("Wooper"),		2,	PokemonType::Water,		PokemonType::Ground),
	PokemonData(MGI_Wugtrio,	std::string("Wugtrio"),		9,	PokemonType::Water,		PokemonType::No_Type),
	PokemonData(MGI_Shroomish,	std::string("Shroomish"),	3,	PokemonType::Grass,		PokemonType::No_Type),
	PokemonData(MGI_Suicune,	std::string("Suicune"),		2,	PokemonType::Water,		PokemonType::No_Type),
};
