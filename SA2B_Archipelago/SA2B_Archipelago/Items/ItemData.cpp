...
std::map<std::string, ItemValue> item_name_to_value = {
    ...
    {"Aaa Trap",                  ItemValue::IV_ExpositionTrap},
    {"Animal Bonus Trap",         ItemValue::IV_PokemonCountTrap},
    {"Animal Trap",               ItemValue::IV_PokemonCountTrap},
    {"Army Trap",                 ItemValue::IV_OmochaoTrap},
    {"Attraction Breakdown Trap", ItemValue::IV_ControllerDriftTrap},
    {"Banana Peel Trap",          ItemValue::IV_IceTrap},
    {"Banana Trap",               ItemValue::IV_IceTrap},
    {"Bubble Trap",               ItemValue::IV_TimeStopTrap},
    {"Bullet Time Trap",          ItemValue::IV_SlowTrap},
    {"Burn Trap",                 ItemValue::IV_PoisonTrap},
    {"Buyon Trap",                ItemValue::IV_OmochaoTrap},
    {"Chaos Trap",                ItemValue::IV_TimeStopTrap},
    {"Confound Trap",             ItemValue::IV_ConfuseTrap},
    {"Confusion Trap",            ItemValue::IV_ConfuseTrap},
    {"Control Ball Trap",         ItemValue::IV_PinballTrap},
    {"Crystal Trap",              ItemValue::IV_TimeStopTrap},
    {"Curse Trap",                ItemValue::IV_PoisonTrap},
    {"Cursed Trap",               ItemValue::IV_PoisonTrap},
    {"Cursed Ball Trap",          ItemValue::IV_PinballTrap},
    {"Damage Trap",               ItemValue::IV_PoisonTrap},
    {"Depletion Trap",            ItemValue::IV_PoisonTrap},
    {"Disable B Trap",            ItemValue::IV_BeeTrap},
    {"Dry Trap",                  ItemValue::IV_PoisonTrap},
    {"E. Gadd Ramblings",         ItemValue::IV_ExpositionTrap},
    {"Empty Item Box Trap",       ItemValue::IV_PoisonTrap},
    {"Energy Drain Trap",         ItemValue::IV_PoisonTrap},
    {"Extreme Chaos Mode",        ItemValue::IV_TimeStopTrap},
    {"Fear Trap",                 ItemValue::IV_SlowTrap},
    {"Fishin' Boo Trap",          ItemValue::IV_FishingTrap},
    {"Flip Trap",                 ItemValue::IV_ReverseTrap},
    {"Food Poisoning Trap",       ItemValue::IV_PoisonTrap},
    {"Freeze Trap",               ItemValue::IV_TimeStopTrap},
    {"Frost Trap",                ItemValue::IV_IceTrap},
    {"Frozen Trap",               ItemValue::IV_TimeStopTrap},
    {"Fuzzy Trap",                ItemValue::IV_ConfuseTrap},
    {"Ghost Trap",                ItemValue::IV_OmochaoTrap},
    {"Gooey Bag",                 ItemValue::IV_OmochaoTrap},
    {"Help Trap",                 ItemValue::IV_ExpositionTrap},
    {"Hey! Trap",                 ItemValue::IV_ExpositionTrap},
    {"Honey Trap",                ItemValue::IV_BeeTrap},
    {"Ice Floor Trap",            ItemValue::IV_IceTrap},
    {"Icy Hot Pants Trap",        ItemValue::IV_IceTrap},
    {"Impatience Trap",           ItemValue::IV_TimeStopTrap},
    {"Instant Crystal Trap",      ItemValue::IV_TimeStopTrap},
    {"Mana Drain Trap",           ItemValue::IV_PoisonTrap},
    {"Mirror Trap",               ItemValue::IV_ReverseTrap},
    {"Nightmare Trap",            ItemValue::IV_CutsceneTrap},
    {"Paralysis Trap",            ItemValue::IV_TimeStopTrap},
    {"Paralyze Trap",             ItemValue::IV_TimeStopTrap},
    {"Paratoad",                  ItemValue::IV_TimeStopTrap},
    {"Phone Trap",                ItemValue::IV_CutsceneTrap},
    {"Poison Mushroom",           ItemValue::IV_TinyTrap},
    {"Poisontoad",                ItemValue::IV_PoisonTrap},
    {"Police Trap",               ItemValue::IV_OmochaoTrap},
    {"PONG Challenge",            ItemValue::IV_PongTrap},
    {"Possession Trap",           ItemValue::IV_PoisonTrap},
    {"PowerPoint Trap",           ItemValue::IV_SlowTrap},
    {"Radiation Trap",            ItemValue::IV_PoisonTrap},
    {"Research Trap",             ItemValue::IV_LiteratureTrap},
    {"Reversal Trap",             ItemValue::IV_ReverseTrap},
    {"Screen Flip Trap",          ItemValue::IV_ReverseTrap},
    {"Shrink Trap",               ItemValue::IV_TinyTrap},
    {"Sleep Trap",                ItemValue::IV_TimeStopTrap},
    {"Sleeptoad",                 ItemValue::IV_TimeStopTrap},
    {"Slip Trap",                 ItemValue::IV_IceTrap},
    {"Slowness Trap",             ItemValue::IV_SlowTrap},
    {"Spam Trap",                 ItemValue::IV_LiteratureTrap},
    {"Stun Trap",                 ItemValue::IV_TimeStopTrap},
    {"Text Trap",                 ItemValue::IV_LiteratureTrap},
    {"Toxin Trap",                ItemValue::IV_PoisonTrap},
    {"Toxin Trap",                ItemValue::IV_PoisonTrap},
    {"Tutorial Trap",             ItemValue::IV_CutsceneTrap},
    {"Yap Trap",                  ItemValue::IV_ExpositionTrap},
    {"UNO Challenge",             ItemValue::IV_MathQuizTrap},
};
