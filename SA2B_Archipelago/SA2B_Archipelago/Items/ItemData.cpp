...
void InitializeItemData(std::map<int, ItemData> &outItemData)
{
    ...
    outItemData[ItemValue::IV_NumberSequenceTrap] = ItemData(0x0000000, std::string("Number Sequence Trap"), std::string(), 0);
    outItemData[ItemValue::IV_LightUpPathTrap]    = ItemData(0x0000000, std::string("Light Up Path Trap"), std::string(), 0);
    outItemData[ItemValue::IV_PinballTrap]        = ItemData(0x0000000, std::string("Pinball Trap"), std::string(), 0);
