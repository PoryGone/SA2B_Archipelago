...
void ItemManager::OnFrameTrapQueue()
{
	...
	else if (this->_ActiveTrap == ItemValue::IV_PokemonTriviaTrap)
	{
		// Nothing
	}
	else if (this->_ActiveTrap == ItemValue::IV_PokemonCountTrap)
	{
		// Nothing
	}
	...
	else if (this->_ActiveTrap == ItemValue::IV_MathQuizTrap)
	{
		// Nothing
	}
	...
	else if (this->_ActiveTrap == ItemValue::IV_InputSequenceTrap)
	{
	// Nothing
	}
