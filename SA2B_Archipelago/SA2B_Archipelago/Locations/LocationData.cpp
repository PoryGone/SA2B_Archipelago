...
void InitializeBigChecks(std::map<int, BigCheckData>& outBigChecks)
{
    ...
    outBigChecks[BigCheck::BC_GreenForest_Big_1]    = BigCheckData(0x01DEEECD, 0x00, LevelIDs_GreenForest,      {  6453,  -1678,   7488 },  { 6369,  -1595,  7201 });
    outBigChecks[BigCheck::BC_WhiteJungle_Big_1]    = BigCheckData(0x01DEEECD, 0x01, LevelIDs_WhiteJungle,      {  9833,  -3080,  -7339 }, 40.0f);
    ...
    outBigChecks[BigCheck::BC_SkyRail_Big_1]        = BigCheckData(0x01DEEECD, 0x04, LevelIDs_SkyRail,          {    45,    405,   -532 }, 40.0f);
    ...
    outBigChecks[BigCheck::BC_IronGate_Big_1]       = BigCheckData(0x01DEEECE, 0x01, LevelIDs_IronGate,         {  1994,   -665,  -1047 }, 25.0f);
    outBigChecks[BigCheck::BC_WeaponsBed_Big_1]     = BigCheckData(0x01DEEECE, 0x02, LevelIDs_WeaponsBed,       {  -203,   -170,  -1530 },  { -201,    -87, -1550 });
    outBigChecks[BigCheck::BC_CityEscape_Big_1]     = BigCheckData(0x01DEEECE, 0x03, LevelIDs_CityEscape,       {  7832, -20608,  16083 }, 50.0f);
    outBigChecks[BigCheck::BC_RadicalHighway_Big_1] = BigCheckData(0x01DEEECE, 0x04, LevelIDs_RadicalHighway,   { -6760,  -2546,  -6134 }, 50.0f);
    outBigChecks[BigCheck::BC_MissionStreet_Big_1]  = BigCheckData(0x01DEEECE, 0x06, LevelIDs_MissionStreet,    {  2796,    200,  -3443 });
    outBigChecks[BigCheck::BC_DryLagoon_Big_1]      = BigCheckData(0x01DEEECE, 0x07, LevelIDs_DryLagoon,        {   193,      2,    969 }, 30.0f);
    ...
    outBigChecks[BigCheck::BC_HiddenBase_Big_1]     = BigCheckData(0x01DEEECF, 0x02, LevelIDs_HiddenBase,       {    60,    160,  -1719 }, 40.0f);
    ...
    outBigChecks[BigCheck::BC_LostColony_Big_1]     = BigCheckData(0x01DEEECF, 0x06, LevelIDs_LostColony,       {  2891,   1241,  -2469 }, 50.0f);
    outBigChecks[BigCheck::BC_PyramidCave_Big_1]    = BigCheckData(0x01DEEECF, 0x07, LevelIDs_PyramidCave,      { -2580,  -1969, -10431 });
    ...
    outBigChecks[BigCheck::BC_MeteorHerd_Big_1]     = BigCheckData(0x01DEEED0, 0x01, LevelIDs_MeteorHerd,       {   584,   -600,    -46 });
    ...
    outBigChecks[BigCheck::BC_FinalChase_Big_1]     = BigCheckData(0x01DEEED0, 0x07, LevelIDs_FinalChase,       {   144,  -9030,  11145 }, 45.0f);
    outBigChecks[BigCheck::BC_MadSpace_Big_1]       = BigCheckData(0x01DEEED1, 0x01, LevelIDs_MadSpace,         {  1090,   4099,    -33 }, 25.0f);
}
